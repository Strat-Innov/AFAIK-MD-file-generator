...
import { Download, FolderTree, Inbox, X } from "lucide-react";
...
export default function BucketView({ bucket, files, md, tags, onReassign, onUnsort, latestChangelogEntry }) {
  const isUnsorted = bucket === UNSORTED;

  const changelogPanel = !isUnsorted && latestChangelogEntry && (
